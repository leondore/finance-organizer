...
CREATE INDEX IF NOT EXISTS "accounts_category_id_idx" ON "accounts" ("category_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "accounts_to_tags_account_id_idx" ON "accounts_to_tags" ("account_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "accounts_to_tags_tag_id_idx" ON "accounts_to_tags" ("tag_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "accounts_to_tags_user_id_idx" ON "accounts_to_tags" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "institutions_user_id_idx" ON "institutions" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "profiles_first_name_last_name_idx" ON "profiles" ("first_name","last_name");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "roles_role_idx" ON "roles" ("role");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "users_email_idx" ON "users" ("email");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "attachments_user_id_idx" ON "attachments" ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "countries_code_idx" ON "countries" ("code");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "currencies_code_idx" ON "currencies" ("code");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "tags_user_id_idx" ON "tags" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "providers_user_id_idx" ON "providers" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "provider_to_category_provider_id_idx" ON "providers_to_categories" ("provider_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "provider_to_category_category_id_idx" ON "providers_to_categories" ("category_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "provider_to_category_user_id_idx" ON "providers_to_categories" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transaction_categories_user_id_idx" ON "transaction_categories" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transaction_sets_user_id_idx" ON "transaction_sets" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transaction_sets_to_transactions_transaction_set_id_idx" ON "transaction_sets_to_transactions" ("transaction_set_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transaction_sets_to_transactions_transaction_id_idx" ON "transaction_sets_to_transactions" ("transaction_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transaction_sets_to_transactions_user_id_idx" ON "transaction_sets_to_transactions" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_account_id_idx" ON "transactions" ("account_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_date_idx" ON "transactions" ("transaction_date");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_user_id_idx" ON "transactions" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_category_id_idx" ON "transactions" ("category_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_provider_id_idx" ON "transactions" ("provider_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_currency_id_idx" ON "transactions" ("currency_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_attachments_transaction_id_idx" ON "transactions_to_attachments" ("transaction_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_attachments_attachment_id_idx" ON "transactions_to_attachments" ("attachment_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_attachments_user_id_idx" ON "transactions_to_attachments" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_tags_transaction_id_idx" ON "transactions_to_tags" ("transaction_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_tags_tag_id_idx" ON "transactions_to_tags" ("tag_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "transactions_to_tags_user_id_idx" ON "transactions_to_tags" ("user_id");--> statement-breakpoint
DO $$ BEGIN
